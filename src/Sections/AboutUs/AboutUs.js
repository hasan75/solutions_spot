            ...
            <div class="container mx-auto px-4 py-12">
                ...
                <section class="mb-16">
                    <div class="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div class="md:w-1/2">
                            <h2 class="text-3xl font-bold text-solprimary mb-6">Our Comprehensive Services</h2>
                ...
                <section class="mb-24 pt-16">
                    <div class="grid md:grid-cols-2 gap-8">
                        <!-- Vision -->
                        <div class="bg-lime-50 p-8 rounded-xl border border-lime-100 order-1 lg:order-2 hover:shadow-lg duration-300">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <h3 class="text-2xl font-bold text-solprimary">Our Vision</h3>
                            </div>
                        ...
                        <div class="order-2 lg:order-1">
                            <h3 class="text-2xl font-bold text-solprimary mb-6">Our Values</h3>
                            <div class="space-y-4">
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md duration-300">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-solprimary">Excellence</h4>
                                ...
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md duration-300">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-solprimary">Trust</h4>
                                ...
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md duration-300">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-solprimary">Convenience</h4>
                                ...
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md duration-300">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-solprimary">Innovation</h4>
                ...
                <section class="mb-24">
                    <div class="text-center mb-10">
                        <h2 class="text-3xl font-bold text-solprimary">Why Choose Solutions Spot?</h2>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            <div class="bg-lime-100 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                            ...
                            <h3 class="font-bold text-solprimary text-lg mb-2">Certified Professionals</h3>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <h3 class="font-bold text-lg mb-2 text-solprimary">Transparent Pricing</h3>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <h3 class="font-bold text-lg mb-2 text-solprimary">On-Time Service</h3>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <h3 class="font-bold text-lg mb-2 text-solprimary">Customizable Packages</h3>
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <h3 class="font-bold text-lg mb-2 text-solprimary">Dedicated Support</h3>
                ...
                <!-- CTA Section -->
                <section class="bg-lime-100 rounded-xl p-8 text-center">
                    <h2 class="text-2xl md:text-3xl font-bold text-solprimary mb-4">Ready to Experience the Solutions Spot Difference?</h2>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="/services.html" class="bg-solprimary text-white font-semibold px-6 py-3 rounded-lg hover:bg-lime-950 transition">Explore Our Services</a>
                        <a href="/#contact" class="bg-transparent border-2 border-lime-950 text-solprimary font-semibold px-6 py-3 rounded-lg hover:bg-white/10 transition">Contact Us</a>
                    </div>
                </section>
            </div>
        </div>
